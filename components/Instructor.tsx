        ...
        <section id="instructor" className="bg-primary text-white  relative overflow-hidden ">
            ...
            <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2  lg:gap-16 items-center">
                    {/* Left Content */}
                    <div className="space-y-4 pt-10 md:pt-0 md:space-y-6">
                        ...
                        <p className="text-base md:text-lg text-white/80 font-medium max-w-lg leading-relaxed">
                            Explore the different sources of money and learn how a basic monetization.
                        </p>

                        <div className="space-y-1">
                            <div className="text-5xl md:text-6xl font-bold text-secondary leading-none">
                                75K +
                            </div>
                    ...
                    <div className="relative h-[250px] md:h-[400px] lg:h-[400px]">
                        <div className="relative w-full h-full flex items-end justify-center lg:justify-end">
                            <Image
                                ...
                                alt="Karan Chawla"
                                fill
                                className="object-contain object-bottom drop-shadow-[0_15px_40px_rgba(255,215,0,0.15)]"
                                priority
                            />
                        </div>
                    </div>
