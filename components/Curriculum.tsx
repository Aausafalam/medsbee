        ...
        <section id="curriculum" className="py-12 md:py-16 bg-white relative overflow-hidden">
            <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
                    ...
                    <h2 className="text-2xl md:text-4xl font-bold text-primary leading-tight">{curriculumData.subtitle}</h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="relative h-[350px] md:h-[500px] group hidden md:block">
                        ...
                        <Image src={curriculumData.image.src || "/placeholder.svg"} alt={curriculumData.image.alt} fill className="object-cover rounded-3xl shadow-xl relative z-10" priority />
                    </div>
