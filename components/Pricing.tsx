    ...
    return (
        <section id="pricing" className="py-8 md:py-12 bg-blue-50/30 overflow-hidden">
            <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative max-w-[600px] mx-auto px-0 md:px-10">
                    <div
                        ref={scrollContainerRef}
                        className="flex md:grid md:grid-cols-1 gap-2 md:gap-4 px-1 lg:gap-8 overflow-x-auto py-6 md:py-8 snap-x snap-mandatory no-scrollbar pb-6 md:pb-8 items-stretch"
                    >
